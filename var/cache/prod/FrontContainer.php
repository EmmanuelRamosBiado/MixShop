...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/bitnami/prestashop/modules/ps_checkout/src/Entity']);
        $d->addExcludePaths([0 => '/bitnami/prestashop/modules/ps_checkout/src/Entity/index.php']);
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/bitnami/prestashop/modules/productcomments/src/Entity']);
        $e->addExcludePaths([0 => '/bitnami/prestashop/modules/productcomments/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/bitnami/prestashop/src/PrestaShopBundle/Entity']), 'PrestaShop');
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.8.5', '/bitnami/prestashop', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.8.5', '/bitnami/prestashop');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.project_dir' => '/bitnami/prestashop',
            'kernel.name' => 'app',
            'kernel.debug' => false,
